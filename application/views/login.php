<body>
    <header>
        <div class="nav-container">
            ...
            <nav>
                <a href="<? echo base_url();?>signup" class="nav-link">Sign in</a>
            </nav>
        </div>
    </header>
    <main>
        ...
        <div class="login-form-container">
            ...
            <form class="login-form" action="<? echo base_url();?>login-user" method="POST">
                <input type="text" class="form-control form-control-sm username" name="username" placeholder="Username or email"/>
                <input type="password" class="form-control form-control-sm password" name="password" placeholder="Password"/>
